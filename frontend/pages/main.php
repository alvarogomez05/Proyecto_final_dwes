...
<body class="bg-sky-700 text-white h-screen flex flex-col">
    <header class="bg-sky-800 p-5 flex items-center justify-between">
        <div class="flex items-center space-x-4">
            <img src="../assets/img/PRqH.gif" alt="Foto de usuario" class="w-12 h-12 rounded-full">
            <div>
    ...
    <main class="flex-1 p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg text-sky-800 text-center">
            ...
            <a href="./Servicios/SelectServicios.php" class="block bg-green-600 text-white font-bold py-2 px-4 rounded mb-3 transition transform hover:bg-green-500 hover:scale-105">Listar Servicios</a>
            ...
            <a href="./Servicios/UpdateServicios.php" class="block bg-yellow-600 text-white font-bold py-2 px-4 rounded mb-3 transition transform hover:bg-yellow-500 hover:scale-105">Modificar Precio Servicio</a>
        </div>
    </main>
</body>
