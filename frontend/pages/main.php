...
<body class="bg-sky-700 text-white h-screen flex flex-col">
    ...
    <main class="flex-1 p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg text-sky-800 text-center">
            ...
            <a href="borrar-empleado.html" class="block bg-red-600 text-white font-bold py-2 px-4 rounded mb-3 transition transform hover:bg-red-500 hover:scale-105">Borrar Empleado</a>

        </div>
        <!-- Columna Listar -->
        <div class="bg-white p-6 rounded-lg shadow-lg text-sky-800 text-center">
            <h2 class="text-2xl font-bold mb-4">Listar</h2>
            <a href="listar-servicios-realizados.html" class="block bg-green-600 text-white font-bold py-2 px-4 rounded mb-3 transition transform hover:bg-green-500 hover:scale-105">Listar Servicios Realizados</a>
            <a href="listar-clientes-perros.html" class="block bg-green-600 text-white font-bold py-2 px-4 rounded mb-3 transition transform hover:bg-green-500 hover:scale-105">Listar Cliente y Perros</a>
            <a href="listar-empleados.html" class="block bg-green-600 text-white font-bold py-2 px-4 rounded mb-3 transition transform hover:bg-green-500 hover:scale-105">Listar Empleados</a>
